...
This gem is a Ruby wrapper for link:https://xiph.org/flac[FLAC] commands. FLACsmith aids in
...
collections easier. This can be especially useful with tools like link:https://iina.io[IINA].
